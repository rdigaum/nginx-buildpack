...
redis2_nginx_url=https://github.com/openresty/redis2-nginx-module.git
...
echo "Downloading $redis2_nginx_url"
(cd nginx-${NGINX_VERSION} && curl -L $redis2_nginx_url )
...
(
	...
	./configure \
		...
		--add-module=/${temp_dir}/nginx-${NGINX_VERSION}/$redis2_nginx_url
	make install
)
